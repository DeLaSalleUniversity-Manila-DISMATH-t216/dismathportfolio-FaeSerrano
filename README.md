...
#Week 2
- I learned that instead of creating a truth table, *I must admit it can be tiresome especially with plenty of variable*, we can use logical equivalences instead.
...
- Quantifiers has two kinds: Universal and Existensial.
  - Universal - should be true to all values.
  - Existensial - true to atleast one value.
  - I understood the concept however I still dont know the usage of this and I hope in the succeeding meeting I'll learn more about it.
